...
datef = tk.Label(frame4, text = "  |  "+day+"-"+mont[month]+"-"+year+"  |  ", fg="#ffffff",bg="#11294f" ,width=55 ,height=1,font=('NSimSun', 14, ' bold '))
datef.pack(fill='both',expand=1)

clock = tk.Label(frame3,fg="orange",bg="#11294f" ,width=55 ,height=1,font=('NSimSun', 14, ' bold '))
...
quitWindow = tk.Button(frame1, text="QUIT", command=window.destroy  ,fg="#03e6ff"  ,bg="#0666a1"  ,width=35 ,height=1, activebackground = "#23bddb" ,font=('NSimSun', 15, ' bold '))
